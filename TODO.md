TODO:
2. Maybe add small caffeine cache in AvroFileServiceImpl? (maxSize=3-5; expirationTime=???). With complex cache key like: pageSize_pageIndex... something else. Main gold -> update AvroFileServiceImpl to avoid rereading file all the time.
